...
export const metadata: Metadata = {
    title: {
        default: "نخلستان معنا | نخل معنا - پلتفرم کاشت نخل و درختکاری هوشمند",
        template: "%s | نخلستان معنا"
    },
    description: "نخلستان معنا؛ سامانه جامع کاشت نخل معنا، درختکاری و احیای محیط زیست. با کاشت نخل، معنا و ارزش به زندگی هدیه دهید. سرمایه معنوی و ماندگار برای خود و عزیزانتان بسازید.",
    ...
    openGraph: {
        title: "نخلستان معنا | نخل معنا - کاشت درخت با معنا",
        description: "با کاشت نخل معنا، زندگی و ارزش را به زمین هدیه دهید. همین امروز در نخلستان معنا نخل خود را بکارید و میراث ماندگار بسازید.",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: 'نخلستان معنا - نخل معنا',
            },
        ],
    },
    twitter: {
        card: 'summary_large_image',
        title: "نخلستان معنا | نخل معنا - درختکاری با هدف",
        description: "نخل معنا؛ پلتفرمی برای پیوند معنا، زندگی و طبیعت. نخل خود را بکارید.",
