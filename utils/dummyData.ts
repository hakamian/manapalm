...
export const INITIAL_PRODUCTS: Product[] = [
    ...
    // --- HIGH TICKET ---
    {
        ...
        type: 'physical',
        points: 150000,
        tags: ['growth', 'self-discovery'], // 30m * 0.005 = 150k points
    ...
    { id: 'p_heritage_group', name: 'نخل گروهی', price: 15000000, points: 75000, category: 'نخل میراث', image: '/images/palm-heritage-group.png', popularity: 80, dateAdded: getPastDate(1), stock: 100, description: 'برای یک هدف یا پروژه گروهی، با هم یک نخل بکارید و تاثیر جمعی خود را ثبت کنید.', type: 'physical', isActive: true, tags: ['community'] },
    {
    ...
    { id: 'p_mana_pack', name: 'بسته معنا (۱۰۰۰ امتیاز)', price: 49000, category: 'ارتقا', image: '/images/service-mana-pack.png', popularity: 100, dateAdded: getPastDate(1), stock: 999, description: 'با خرید این بسته، ۱۰۰۰ امتیاز معنا به حساب خود اضافه کنید تا به ابزارهای هوشمند دسترسی پیدا کنید.', type: 'service', points: 0, isActive: true },
