...
export const INITIAL_PRODUCTS: Product[] = [
    ...
    { id: 'p_heritage_group', name: 'نخل گروهی', price: 15000000, points: 75000, category: 'نخل میراث', image: 'https://res.cloudinary.com/dk2x11rvs/image/upload/v1766819374/manapalm/heritage/palm-heritage-group.jpg', popularity: 80, dateAdded: getPastDate(1), stock: 100, description: 'برای یک هدف یا پروژه گروهی، با هم یک نخل بکارید و تاثیر جمعی خود را ثبت کنید.', type: 'physical', isActive: true, tags: ['community'] },
    {
    ...
    { id: 'p_heritage_memorial', name: 'نخل یادبود', price: 8900000, category: 'نخل میراث', image: 'https://res.cloudinary.com/dk2x11rvs/image/upload/v1766819376/manapalm/heritage/palm-heritage-memorial.jpg', popularity: 92, dateAdded: getPastDate(15), stock: 50, description: 'زنده نگه داشتن یاد و خاطره عزیزان با هدیه کردن یک زندگی جدید به طبیعت.', type: 'physical', isActive: true, points: 44500, tags: ['legacy', 'family', 'memory'] },
