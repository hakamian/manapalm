...
export const INITIAL_PRODUCTS: Product[] = [
    ...
    { id: 'p_heritage_group', name: 'نخل گروهی', price: 15000000, points: 75000, category: 'نخل میراث', image: 'https://images.unsplash.com/photo-1545235617-9465d2a55698?q=80&w=800&auto=format&fit=crop', popularity: 80, dateAdded: getPastDate(1), stock: 100, description: 'برای یک هدف یا پروژه گروهی، با هم یک نخل بکارید و تاثیر جمعی خود را ثبت کنید.', type: 'physical', isActive: true, tags: ['community'] },
    {
