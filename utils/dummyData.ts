...
export const INITIAL_PRODUCTS: Product[] = [
    ...
    {
        id: 'mp_dates_piarom',
        name: 'خرمای پیارم ارگانیک حاجی‌آباد (ممتاز)',
        price: 850000,
        ...
        stock: 45,
        description: 'خرمای پیارم ارگانیک، معروف به شکلات طبیعی جنوب. دست‌چین شده از بهترین نخلستان‌های حاجی‌آباد، بدون کود شیمیایی و مواد نگهدارنده. غنی از کلسیم، پتاسیم و فیبر.',
        type: 'physical',
        isActive: true,
        tags: ['organic', 'premium', 'health'],
        points: 1700
    },
    {
        id: 'mp_dates_mazafati',
        name: 'خرمای مضافتی ارگانیک (بم)',
        price: 350000,
        category: 'محصولات ارگانیک',
        image: 'https://images.unsplash.com/photo-1582283415560-6415f381c828?q=80&w=2070&auto=format&fit=crop',
        popularity: 92,
        dateAdded: getPastDate(3),
        stock: 120,
        description: 'خرمای مضافتی درجه یک با بافتی نرم و طعمی دلچسب. بسته‌بندی ۱۰۰٪ قابل بازیافت و اکو-فرندلی. تولید شده در مزارع تحت حمایت نخلستان معنا با رویکرد مسئولیت اجتماعی.',
        type: 'physical',
        isActive: true,
    ...
    {
        id: 'mp_dates_zahedi',
        name: 'خرمای زاهدی (طلایی و خشک)',
        price: 280000,
        category: 'محصولات ارگانیک',
        image: 'https://images.unsplash.com/photo-1596560548464-f01068e3c70f?q=80&w=2070&auto=format&fit=crop',
        popularity: 85,
        dateAdded: getPastDate(5),
        stock: 60,
        description: 'خرمای زاهدی با قند کنترل شده، مناسب برای ورزشکاران و رژیم‌های سلامت. این محصول مستقیماً از کشاورزان بومی خریداری شده تا بیشترین سود به تولیدکننده واقعی برسد.',
        type: 'physical',
        isActive: true,
        tags: ['organic', 'health', 'fair-trade'],
        points: 560
    },
    {
        id: 'mp_dates_luxury_box',
        name: 'پکیج هدیه "معنا و برکت"',
        price: 1500000,
        category: 'محصولات ارگانیک',
        ...
        dateAdded: getPastDate(1),
        stock: 20,
        description: 'باکس لوکس شامل ترکیبی از بهترین خرماهای مضافتی و پیارم، به همراه یک گواهی نمادین کاشت نخل به نام هدیه گیرنده. یک انتخاب عالی برای هدایای سازمانی و مسئولیت اجتماعی.',
        type: 'physical',
        isActive: true,
        tags: ['gift', 'luxury', 'social-impact'],
        points: 3000
    },
    {
        id: 'p4',
