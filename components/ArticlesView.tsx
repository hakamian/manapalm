...
const mockArticles: Article[] = [
    ...
    },
    {
        ...
        content: 'در این مقاله، به بررسی کاربردهای عملی مدل Gemini برای سازمان‌های غیرانتفاعی و کسب‌وکارهای اجتماعی می‌پردازیم. از تولید محتوای جذاب برای کمپین‌های جذب سرمایه گرفته تا تحلیل بازخورد مشتریان برای بهبود خدمات، Gemini می‌تواند به عنوان یک همکار هوشمند و خستگی‌ناپذیر عمل کند. ما موارد مطالعاتی واقعی را بررسی می‌کنیم.', type: 'official', likes: 210, authorImage: '/images/avatar-female.png'
    },
    {
        ...
        content: 'متن کامل داستان در اینجا قرار می‌گیرد...', type: 'community', likes: 350, authorImage: '/images/avatar-female.png'
    },
    {
    ...
    },
    {
        ...
        content: 'متن کامل داستان در اینجا قرار می‌گیرد...', type: 'community', likes: 421, authorImage: '/images/avatar-male.png'
    },
    {
        ...
        content: 'متن کامل مقاله در اینجا قرار می‌گیرد...', type: 'official', likes: 95, authorImage: '/images/avatar-female.png'
    },
    {
        ...
        content: 'متن کامل مقاله در اینجا قرار می‌گیرد...', type: 'official', likes: 140, authorImage: '/images/avatar-male.png'
    },
    {
        ...
        content: 'متن کامل مقاله در اینجا قرار می‌گیرد...', type: 'official', likes: 195, authorImage: '/images/avatar-female.png'
    }
];
