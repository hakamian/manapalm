                            ...
                            <ReactMarkdown
                                ...
                                components={{
                                    ...
                                    a: ({ node, href, children, ...props }) => (
                                        <a href={href || '#'} className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-emerald-400 bg-emerald-400/10 hover:bg-emerald-400/20 transition-colors font-medium border-b border-emerald-400/30 hover:border-emerald-400 no-underline" {...props}>
                                            {children}
