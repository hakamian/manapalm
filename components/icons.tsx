...
export const TreasureIcon = React.memo((props: React.SVGProps<SVGSVGElement>) => (
...
export const OpenTreasureIcon = React.memo((props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export const SparklesBurstIcon = React.memo((props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
